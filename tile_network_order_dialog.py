...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'tile_network_order_dialog_base.ui'))


class TileNetworkOrderDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(TileNetworkOrderDialog, self).__init__(parent)
